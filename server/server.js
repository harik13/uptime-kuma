 ...
 */
console.log("Welcome to Vconsol Eyes");
...
// Exit Vconsol Eyes immediately if the Node.js version is banned
...
log.info("server", "Vconsol Eyes Version: " + checkVersion.version);
        ...
        socket.on("setup", async (username, password, callback) => {
            try {
                ...
                if ((await R.knex("user").count("id as count").first()).count !== 0) {
                    throw new Error("Vconsol Eyes has been initialized. If you want to run setup again, please delete the database.");
                }
...
async function initDatabase(testMode = false) {
    ...
    // If there is no record in user table, it is a new Vconsol Eyes instance, need to setup
    if ((await R.knex("user").count("id as count").first()).count === 0) {
